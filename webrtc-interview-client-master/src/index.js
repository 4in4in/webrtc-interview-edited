...
const serverConnection = createConnection('wss://localhost:5003');
...
Interview.iceServers = [
  ...
  // {
    ...
    // credential: 'JZEOEt2V3Qb0y27GRntt2u2PAYA=',
    // username: '28224511:1379330808',
  //   url: 'turn:192.168.201.222:3478?transport=udp',
  //   username: 'username2',
  //   password: 'password2'
  // },
...
ClientsList.clientsServer = 'https://localhost:5003';
